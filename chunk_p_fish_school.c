...
int main(int argc, char *argv[])
{
	...
	printf("parallel,%d,%d,%d,%f,%f,%f,%f,%s,%s\n", OMP_NUM_THREADS, SCHOOL, STEPS, time_results.cpu_cycles_elapsed, time_results.omp_elapsed, time_results.monotonic_elapsed, time_results.posix_cputime_elapsed,XSTR(SCHED),XSTR(CHUNK_SIZE));
}
